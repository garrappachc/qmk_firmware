...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case KC_SPC:
        ...
        if (record->event.pressed) {
            rgblight_sethsv_noeeprom(21, 255,  255);
        } else {
            update_rgblight();
        }
        return true;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_60_ansi(
        ...
        KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_END,  KC_TRNS, KC_TRNS, KC_TRNS, _______,                 _______,
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                             KC_TRNS, _______, _______, KC_TRNS
    )
};
